...
public class RelativeColor implements UIDefaults.LazyValue {
     ...
     *
     * @param base A Color or UIManager key for a color that the target color is
     * related to
     * @param target A Color or UIManager key for a color that is what the
     * target color should be if the actual color is equal to the base color
     * @param actual Either a Color object or a UIManager String key resolvable
     * to a color, which represents the actual color, which may or may not match
     * the target color
